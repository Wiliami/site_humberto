...
class Component {
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="' . BASE . '/painel/admin/matriculas/cursos/create">
                        <i class="fas fa-folder-plus"></i>
                            No curso
                        </a>
                        <a class="collapse-item" href="' . BASE . '/painel/admin/matriculas/aulas/create">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="' . BASE . '/painel/area-member/courses/minhas-compras">
    ...
    public function getLogoutModal() {
        return '
        <!-- Logout Modal -->
