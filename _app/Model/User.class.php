...
class User {
	...
	public static function loginn($login, $password)
	{
	...
	public static function checkLoginExist($login)
	{
		...
		$results = $sql->select("SELECT * FROM users WHERE deslogin = :deslogin", [':deslogin'=>$login ]);
	...
	public function verifyUserAdminLogin($inadmin = true) {
		return "ok";
	}
