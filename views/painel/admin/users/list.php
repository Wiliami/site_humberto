...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="<?= BASE ?>/painel/admin/users/create" class="btn btn-success rounded-pill" title="Voltar para a lista de usuários" style="border-radius: 50%; font-size: 12px;">Cadastrar novo usuário</a>
        </div>
        <div class="card-body">
