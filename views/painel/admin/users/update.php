...
<div class="container">
    ...
    <!-- <div class="form-group">
        ...
        <a href="<?= BASE ?>/painel/profile/courses/courses-users&course=<?= $User['user_id'] ?>" class="btn btn-outline-success mb-2" title="Área cursos de usuário">Ver cursos do usuário</a>
    </form>
    <?php
        }
    } else {
