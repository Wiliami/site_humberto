                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= BASE ?>/painel/matriculas-aulas/delete&delete_matricula_aula=<?= $MatAulas['matricula_id'] ?>" class="table-link danger" title="Excluir matrícula de <?= $Matriculas['matricula_usuario'] ?>">
                                    <span class="fa-stack">
                                        <i class="fa fa-square fa-stack-2x"></i>
