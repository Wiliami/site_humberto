...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">Excluir módulos</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="table-deletar-modulos" class="table table-striped table-bordered" style="width: 100%;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <a href="<?= BASE ?>/painel/courses/update" class="table-link" title="Atualizar">
                                    <span class="fa-stack">
                                        <i class="fa fa-square fa-stack-2x"></i>
...
$(document).ready(function() {
    $("#table-deletar-modulos").DataTable({
        "language": {
