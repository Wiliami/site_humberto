        ...
        <div class="col-12 mx-auto">
            ...
            <div class="col-lg-7 col-md-7 z-index-2 position-relative px-md-2 px-sm-5 mx-auto" style="margin-top: 20px;">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    A sua privacidade é importante para nós. É política do Humberto Oliveira respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Humberto Oliveira, e outros sites que possuímos e operamos. <br/>
                    ...
                    O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contacto conosco.<br/>
                    </p>
                    ...
                    <p class="text-lg mb-0"> 
                    O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Humberto Oliveira oferece no site e com caráter enunciativo, mas não limitativo:
                        <li>
                        ...
                        <li>
                        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Humberto Oliveira, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados. </li>
                    </p>
