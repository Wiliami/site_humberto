                ...
                <div class="row py-5">
                    <div class="col-lg-7 col-md-7 z-index-2 position-relative px-md-2 px-sm-5 mx-auto"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h3 class="mb-0">Política Privacidade</h3>
                        </div>
                        <p class="text-lg mb-0">
                            A sua privacidade é importante para nós. É política do Humberto Oliveira respeitar a sua
                            privacidade em relação a qualquer informação sua que possamos coletar no site Humberto
                            Oliveira, e outros sites que possuímos e operamos. <br />
                            ...
                            responsabilidade por suas respectivas políticas de privacidade.<br />

                            Você é livre para recusar a nossa solicitação de informações pessoais, entendendo que talvez
                            não possamos fornecer alguns dos serviços desejados.<br />
                            ...
                            dados do usuário e informações pessoais, entre em contacto conosco.<br />
                        </p>

                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h3 class="mb-0">Política de Cookies Humberto Oliveira</h3>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0">O que são cookies?</h5>
                        </div>
                        <p class="text-lg mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0">Como usamos os cookies?</h5>
                        </div>
                        <p class="text-lg mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0">Desativar cookies</h5>
                        </div>
                        <p class="text-lg mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0">Cookies que definimos</h5>
                        </div>
                        <p class="text-lg mb-0">
                            <li>Cookies relacionados à conta</li>
                            Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de
                            inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair
                            do sistema, porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as
                        ...
                        <p class="text-lg mb-0">
                            ...
                            ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas
                        ...
                        <p class="text-lg mb-0">
                            ...
                            interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão.
                        ...
                        <p class="text-lg mb-0">
                            ...
                            contacto ou nos formulários de comentários, os cookies podem ser configurados para lembrar
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0">Cookies de Terceiros</h5>
                        </div>
                        <p class="text-lg mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0">Compromisso do Usuário</h5>
                        </div>
                        <p class="text-lg mb-0">
                            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Humberto
                            Oliveira oferece no site e com caráter enunciativo, mas não limitativo:
                            <li>
                                A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem
                                pública;</li>

                            <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, jogos de hoje ou
                                azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os
                                direitos humanos;</li>

                            <li>
                                C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Humberto
                                Oliveira, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
