        ...
        <div class="col-12 mx-auto">
            ...
            <div class="col-lg-7 col-md-7 z-index-2 position-relative px-md-2 px-sm-5 mx-auto">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h3 class="mb-0">Termos e Condições de Uso!</h3>
                </div>
                <p class="text-lg mb-0">
                Seja bem-vindo ao Humberto Oliveira!
                Estes termos e condições descrevem as regras de uso do site da empresa Humberto Oliveira, localizada no endereço https://www.humbertooliveira.net.
                Ao acessar este site, consideramos que você está de acordo com os termos e condições abaixo. Não continue a usar o Humberto Oliveira caso você discorde dos termos e condições descritos neste contrato.
                </p>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="mb-0">Cookies:</h5>
                </div>
                <p class="text-lg mb-0">
                O site usa cookies para ajudar na pesonalização da sua experiência na internet. Ao acessar o site Humberto Oliveira, você concorda com o uso dos cookies requeridos.
                ...
                Nós podemos usar cookies para coletar, armazenar ou rastrear informações para finalidades estatísticas e mercadológicas do nosso site. Você tem a opção de aceitar ou rejeitar os cookies opcionais. Existem alguns cookies obrigatórios, que são necessários para o funcionamento de nosso site. Esses cookies obrigatórios são requerem seu consentimento. Por favor tenha em mente que, ao aceitar os cookies obrigatórios, você também estará aceitando cookies de terceiros, que podem ser usados por terceiros caso você utilize serviços fornecidos por eles em nosso site – por exemplo, uma janela de reprodução de vídeo fornecida por empresas terceiras e integrada ao nosso site. Não continue a usar o Humberto Oliveira caso você discorde dos termos e condições descritos neste contrato.
                </p>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="mb-0">Licença:</h5>
                </div>
                <p class="text-lg mb-0">
                Exceto em casos em que for indicado o contrário, Humberto Oliveira e seus licenciados têm direito à propriedade intelectual de todo o material postado no Humberto Oliveira. Todos os direitos à propriedade intelectual são reservados.
                Você não tem permissão para:
                <li>Copiar ou republicar materiais do Humberto Oliveira</li>
                <li>Vender, alugar ou sublocar materiais do Humberto Oliveira</li>
                <li>Reproduzir, duplicar ou copiar materiais do Humberto Oliveira</li>
                <li>Redistribuir conteúdos do Humberto Oliveira</li>
                Este Acordo terá efeito a partir da data presente.
                Partes deste site oferecem ao usuário a oportunidade de postar e discutir opiniões e informações em determinadas áreas. Humberto Oliveira não filtra, edita, publica ou revisa Comentários antes que eles sejam apresentados no site. Comentários refletem as opiniões da pessoa que os posta. Na extensão em que as leis aplicáveis permitem, Humberto Oliveira não se responsabiliza legalmente pelos Comentários ou quaisquer danos, riscos ou despesas causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência dos Comentários deste site.
                Humberto Oliveira reserva para si o direito de recomer quaisquer Comentários que possa ser considerado inapropriado, ofensivo ou quebre os Termos e Condições deste contrato.
                ...
                Você por meio deste concede a Humberto Oliveira a licença não-exclusiva de usar, reproduzir, editar e autorizar outros a usar, reproduzir ou editar qualquer um de seus Comentários em qualquer e todas as formas, formatos e mídias.
                </p>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="mb-0">Criação de links para nosso conteúdo</h5>
                </div>
                <p class="text-lg mb-0"> 
                ...
                Nós vamos aprovar solicitações de link feitas pelos tipos de organização listados acima se julgarmos que: (a) o link não é desfavorável para nossa imagem e/ou para a imagem de empresas credenciadas; (b) a organização solicitante não possui histórico negativo conosco; (c) o benefício que ganhamos com a visibilidade do link compensa a ausência do Humberto Oliveira; e (d) o link será inserido em um contexto geral informativo. <br/>
                Essas organizações podem postar links para nossa página inicial contanto que o link: (a) não seja, de forma alguma, enganoso; (b) não insinue falsamente a existência de uma relação de patrocínio, endosso, ou aprovação de produtos e/ou serviços da nossa parte; e (c) seja apropriado ao contexto em que está sendo inserido. <br/>
                Se você representa uma das organizações listadas no parágrafo 2 acima e está interessado em postar um link para nosso site, você deve nos informar de seu interesse enviando um e-mail para Humberto Oliveira. Por favor, inclua seu some, o nome da sua organização e suas informações de contato, assim como a URL do seu site, uma lista das URLs do nosso site que você pretende usar como links, e uma lista dos sites nos quais você pretende publicar nossas URLs. Aguarde entre 2 e 3 semanas para receber uma resposta. <br/>
                ...
                Não será permitido o uso ou a publicação de links para o logo e/ou outros elementos visuais da Humberto Oliveira sem um acordo de licença para o uso da marca registrada.
                </p>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="mb-0">Responsabilização pelo Conteúdo:</h5>
                </div>
                <p class="text-lg mb-0"> 
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <h5 class="mb-0">Declaração de Isenção de Responsabilidade:</h5>
                </div>
                <p class="text-lg mb-0"> 
                ...
                As limitações e proibições de responsabilização listadas nesta Seção e em outras partes desta declaração: (a) estão sujeitas ao parágrafo anterior; e (b) regem todas as responsabilizações que surgirem sob a declaração, incluindo responsabilizações surgidas em contrato, em delitos e em quebra de obrigações legais. <br/>
