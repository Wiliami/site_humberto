        ...
        <div class="container">
            <div class="row">
                <div class="my-5 text-center text-xl-start">
                    <img src="<?= BASE ?>/src/images/youtube-white.png"  class="d-sm-flex justify-content-sm-center justify-content-xl-start" alt="youtube logo"
        ...
        <div class="row gx-5">
            <div class="col-lg-4 mb-5">
                <div class="d-flex align-items-center">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/NqS42PgzG00"
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <div class="d-flex align-items-center">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/RIDwf9LZP0M"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </div>
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <div class="d-flex align-items-center">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/YJswtuiYLNc"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </div>
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <div class="d-flex align-items-center">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/x15_wgECOSg"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </div>
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <div class="d-flex align-items-center">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/uhuDxPtoYyo"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </div>
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <div class="d-flex align-items-center">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/6n58QTH3xLc"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </div>
